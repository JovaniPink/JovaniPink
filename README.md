...
| Project | Focus |
| --- | --- |
| [JovaniPink Skills](https://github.com/JovaniPink/skills) | Reusable agent workflows for clearer results and resumable work, with separate setup and behavior checks for Codex, Claude, and Antigravity. [Getting Started with JovaniPink Skills](https://jovanipink.com/posts/getting-started-with-jovanipink-skills). |
